...
Public Class CrystalReportImage
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CSM_Deans_Office_Management_System.CrystalReportImage.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportImage
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportImage = New CrystalReportImage()
        rpt.Site = Me.Site
        Return rpt
    End Function
