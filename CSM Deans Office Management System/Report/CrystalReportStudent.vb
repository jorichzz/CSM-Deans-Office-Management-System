...
Public Class CrystalReportStudent
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CSM_Deans_Office_Management_System.CrystalReportStudent.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportStudent
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportStudent = New CrystalReportStudent()
        rpt.Site = Me.Site
        Return rpt
    End Function
